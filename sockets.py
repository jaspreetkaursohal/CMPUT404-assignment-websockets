    ...
    try:
        while True:
            ...
            if (msg is not None):
                ...
                for each_val in packet:
                    myWorld.set(each_val, packet[each_val])
...
#taken from assignment 4 and updated as needed
def update(entity):
    '''update the entities via this interface'''
    json_entity = flask_post_json()
